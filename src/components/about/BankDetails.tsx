    ...
    <section id="org">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        ...
        >
          ...
          {/* Heading */}
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1b1c19] mb-6 font-[Noto_Serif]">
            A Legacy of Service
          </h2>

          {/* Quote / Content */}
          <p className="text-[#44474e] text-base sm:text-lg leading-relaxed italic max-w-2xl mx-auto">
