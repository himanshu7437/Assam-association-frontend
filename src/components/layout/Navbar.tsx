...
export default function Navbar() {
  ...
  <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 h-full flex items-center justify-between">
    ...
    {/* BRAND */}
    <Link href="/" className="flex items-center gap-2 min-w-0 max-w-[60%]">
      <Image
      ...
      {/* 🔥 KEY FIX: truncate instead of overflow */}
      <span className="font-[Noto_Serif] text-sm sm:text-base md:text-lg font-bold text-white truncate">
